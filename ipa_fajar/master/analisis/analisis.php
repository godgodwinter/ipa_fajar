...
<div class="col-md-12 panel-info">
	<div class="content-box-large box-with-header">
	<!---<a href="?v=report&bln_m=<?php echo $bulan_mulai; ?>&bln_s=<?php echo $bulan_sampai; ?>" target="_blank" class="btn btn-info btn-lg navbar-right"><span class="glyphicon glyphicon-print"></span> Cetak</a><br> -->
<?php
