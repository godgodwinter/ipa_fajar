...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2018 at 11:11 AM
...
CREATE TABLE IF NOT EXISTS `tb_kuesioner` (
  `kd_kuesioner` int(10) NOT NULL AUTO_INCREMENT,
  `tanggal` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `kritik_saran` text NOT NULL,
  PRIMARY KEY (`kd_kuesioner`),
  UNIQUE KEY `kd_kuesioner` (`kd_kuesioner`),
  UNIQUE KEY `kd_kuesioner_2` (`kd_kuesioner`)
